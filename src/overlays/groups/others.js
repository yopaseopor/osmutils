...
},
{
    ...
    query: "[out:json][timeout:25];(nwr[\"shop\"=\"model\"]({{bbox}});node(w););out meta;",
    iconSrc: "src/img/logos/generic.svg",
    iconStyle: "background-color:rgba(255,255,255,0.4)",
    style: function (feature) {
        var key_regex = /^name$/
...
},
{
    ...
    title: getTranslation('plant_hire'),
    query: "[out:json][timeout:25];(nwr[\"shop\"=\"plant_hire\"]({{bbox}});node(w););out meta;",
    iconSrc: "src/img/logos/generic.svg",
    iconStyle: "background-color:rgba(255,255,255,0.4)",
    style: function (feature) {
        var key_regex = /^name$/
